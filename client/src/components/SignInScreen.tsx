...
export default function SignInScreen({ onSignIn, coverImage }: Props) {
  ...
  return (
    <div className="min-h-dvh bg-ot-yellow flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <button
          onClick={() => login()}
          className="w-full flex items-center justify-center gap-3 bg-ot-black text-white font-semibold text-base rounded-xl px-6 py-4 shadow-lg active:scale-95 transition-transform"
        >
          <GoogleIcon />
          Sign in with Google
        </button>
